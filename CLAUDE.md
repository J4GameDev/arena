...
**The opening is a scene, not a briefing.** A title card — the game is called _Farther_ — then four short lines that walk the player in through the gate: the wall and the gate closing behind them, the smell of the town and a child pulled back from a doorway, the woods still green but the elk no longer running, and a hunter walking over. Each one a click, skippable. Then Oswald, in his own few words, hands over the only choice the game makes for you: the weapon. Choosing sends the player straight into the yard to spar with him, and the Hunter's Pack lands at the end of it. There is no camp until you have shown him you can hold the thing.
